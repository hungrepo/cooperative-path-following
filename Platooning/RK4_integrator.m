    ...
    for i = 1:nSteps
        ...
        if compute_sensitivities
            ...
            for j = 1:nu
                ...
                xTemp1 = rk4_step(ode_fun,x0,uTemp1,h,t);
...
function x_next = rk4_step(ode_fun,x,u,h,t)
    k1 = ode_fun(t,x,u);
    k2 = ode_fun(t,x+h/2.*k1,u);
    k3 = ode_fun(t,x+h/2.*k2,u);
    k4 = ode_fun(t,x+h.*k3,u);
