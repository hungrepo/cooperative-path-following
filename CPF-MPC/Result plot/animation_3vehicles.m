...
for i=1:1:size(p2,1)%data.i,
    ...
    figure(fig1);
    % path black
%     plot(pd1(1:i,2),pd1(1:i,1),'-','LineWidth',0.2,'Color',[200,200,0]/255);
%     hold on;
%     plot(pd2(1:i,2),pd2(1:i,1),'-','LineWidth',0.2,'Color',[10,10,0]/255);
%     plot(pd3(1:i,2),pd3(1:i,1),'-','LineWidth',0.2,'Color',[200,10,10]/255);
...
%     plot(p3(1:i,2),p3(1:i,1),'.-','LineWidth',0.5,'Color',[200,10,10]/255);
...
%     plot(p33(1:i,2),p33(1:i,1),'-','LineWidth',0.2,'Color',[200,10,10]/255);
   ...
   Scale=.2;
    ...
    GTF_Simulink_PlotAUV([p1(i,2),p1(i,1),0], [0,0,yaw1_1(i)], Scale, 0,AUV_COL2,1); 
    GTF_Simulink_PlotAUV([p2(i,2),p2(i,1),0], [0,0,yaw2_2(i)], Scale, 0,AUV_COL3,1);  
