...
%     plot(pd33(1:i,2),pd33(1:i,1),'-','LineWidth',0.2,'Color',[200,10,10]/255);
    ...
    plot(p6(1,2),p6(1,1),'.-','LineWidth',0.5,'Color',[10,10,0]/255);
...
%     plot(p33(1:i,2),p33(1:i,1),'-','LineWidth',0.2,'Color',[200,10,10]/255);
   ...
   Scale=.3;
    ...
    GTF_Simulink_PlotAUV([p6(1,2),p6(1,1),1], [0,0,yaw6_6], Scale, 0,AUV_COL6,1);  hold on
%      GTF_Simulink_PlotAUV([p6(1,2),p6(1,1),5], [0,0,yaw6_6], Scale, 0,AUV_COL6,1);  
