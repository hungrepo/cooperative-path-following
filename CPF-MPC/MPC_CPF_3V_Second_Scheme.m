...
import casadi.*
[nlp_sol1,w01,lbw1,ubw1,lbg1,ubg1,nx1,nu1,k3]=NLP1(Np,Tp,Ts,path1_data);
[nlp_sol2,w02,lbw2,ubw2,lbg2,ubg2,nx2,nu2,k3]=NLP2(Np,Tp,Ts,path2_data);
[nlp_sol3,w03,lbw3,ubw3,lbg3,ubg3,nx3,nu3,k3]=NLP1(Np,Tp,Ts,path3_data);
...
x0_1=[e_pf1;gamma2;uc2];
x0_2=[e_pf2;gamma1;gamma3;uc1;uc3];
x0_3=[e_pf3;gamma2;uc2];
...
uc1=SX.sym('uc1');
x = [s1;y1;psie;gamma_i;gamma_j;uc1];
nx=length(x);
...
uc1=SX.sym('uc1');
uc2=SX.sym('uc2');
x = [s1;y1;psie;gamma_i;gamma_j1;gamma_j2;uc1;uc2];
nx=length(x);
% input of PF error system 
r = SX.sym('r');
u_g=SX.sym('u_g');
...
L = [s1, y1, psie, (vd+u_dt)*hg_i*cos(psie)-hg_i*u_g, r-cg_i*hg_i*u_g]*Q*[s1;y1;psie;...
                                                                (vd+u_dt)*hg_i*cos(psie)-hg_i*u_g;...
                                                                r-cg_i*hg_i*u_g] + ...
    [2*gamma_i-gamma_j1-gamma_j2, u_dt]*R*[2*gamma_i-gamma_j1-gamma_j2; u_dt];
%% Continuous time dynamics
f = Function('f', {x, u}, {xdot, L});
