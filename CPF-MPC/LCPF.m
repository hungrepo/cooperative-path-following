...
%% Compute correction speed
L=[ 1  -1  0;        % network
   -1   2 -1;
    0  -1  1];
k=0.3;
gamma=[gamma1;gamma2;gamma3];
eta=-k*tanh(0.1*L*gamma);
uc1=eta(1); uc2=eta(2);uc3=eta(3);
uc=[uc eta];
%% Compute control law for PF 
% Find PF control law for vehicle 1
    u_pf1=LPF(e_pf1,path1_data);
    r_d1=u_pf1(1);
    u_gamma1=u_pf1(2);
% Find PF control law for vehicle 2
    u_pf2=LPF(e_pf2,path2_data);
    r_d2=u_pf2(1);
    u_gamma2=u_pf2(2);
% Find PF control law for vehicle 3
    u_pf3=LPF(e_pf3,path3_data);
    r_d3=u_pf3(1);
    u_gamma3=u_pf3(2);
